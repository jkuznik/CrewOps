...
public class EmployeeQualificationForm extends FormLayout {
    ...
    private void configureAddButtonClickListener(EmployeeFormModel employeeFormModel, CoreAPI coreAPI) {
        ...
        add.addClickListener(event -> {
            try {
                ...
                fireEvent(new AssignQualificationEvent(this, employeeDTO));
    ...
    public abstract static class EmployeeQualificationFormEvent extends ComponentEvent<EmployeeQualificationForm> {
        ...
        public EmployeeQualificationFormEvent(EmployeeQualificationForm source, EmployeeDTO employeeDTO) {
            super(source, false);
            this.employeeDTO = employeeDTO;
        }
    }

    public static class AssignQualificationEvent extends EmployeeQualificationFormEvent {
        AssignQualificationEvent(EmployeeQualificationForm source, EmployeeDTO employeeDTO) {
            super(source, employeeDTO);
        }
    }

    public Registration addAssignQualificationListener(ComponentEventListener<AssignQualificationEvent> listener) {
        return addListener(AssignQualificationEvent.class, listener);
    }
}
