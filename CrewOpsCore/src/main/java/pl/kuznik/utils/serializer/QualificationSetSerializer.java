...
public class QualificationSetSerializer extends JsonSerializer<Set<Qualification>> {
    ...
    @Override
    public void serialize(Set<Qualification> qualifications, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        gen.writeObject(qualifications.stream()
