...
SERVICE_NAME="crewops-vaadin-service"
TASK_FAMILY="crewops-vaadin"

# Local task definition JSON file
TASK_FILE="$SCRIPT_DIR/crewops-vaadin-latest-task-definition.json"
...
# This ensures we have the exact latest revision
